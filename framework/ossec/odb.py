...
class OssecDBConnection:
    ...
    def __init__(self, request_slice=20, max_size=6144):
        ...
        try:
            ...
            raise OSSECAPIException(2005, strerror(e[0]))
    ...
    def __query_input_validation(self, query):
        ...
        for check, error_text in input_val_errors:
            if not check:
                raise OSSECAPIException(2004, error_text)
    ...
    def __send(self, msg):
        ...
        if data[0] == "err":
            raise OSSECAPIException(2003, data[1])
        else:
    ...
    def execute(self, query, count=False):
        ...
        if 'count' not in query_lower:
            ...
            try:
                ...
                raise OSSECAPIException(2006, str(e))
            except Exception as e:
                raise OSSECAPIException(2007, str(e))
